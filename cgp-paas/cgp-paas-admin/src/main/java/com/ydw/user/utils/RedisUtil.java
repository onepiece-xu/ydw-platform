...
public final class RedisUtil {
	...
	public boolean lock(String key, String value) {
        ...
        if (redisTemplate.opsForValue().setIfAbsent(key, value)) {
            ...
            //如果锁过期
            if (StringUtil.isNotBlank(currentValue)
                    && Long.parseLong(currentValue) < System.currentTimeMillis()) {
                String oldValue = redisTemplate.opsForValue().getAndSet(key, value).toString();
                //是否已被别人抢占
                bool = StringUtil.isNotBlank(oldValue) && oldValue.equals(currentValue);
            }
        }
        return bool;
    }
    ...
    public void unlock(String key, String value) {
        try {
            String currentValue = redisTemplate.opsForValue().get(key).toString();
            if (StringUtil.isNotBlank(currentValue) && currentValue.equals(value)) {
