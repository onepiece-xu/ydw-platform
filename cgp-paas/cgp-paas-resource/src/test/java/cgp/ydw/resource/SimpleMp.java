...
//	@Test
    public void generateCode() {
        //指定包名
        String packageName = "com.ydw.resource";
        //指定生成的表名


        String[] tableNames = new String[]{"tb_task","tb_task_cluster"};
...
//                .setDbColumnUnderline(true)
    ...
    private DataSourceConfig getDataSourceConfig() {
        String dbUrl = "jdbc:mysql://121.36.97.240:3306/cgp_paas?tinyInt1isBit=false&useUnicode=true&characterEncoding=utf8&autoReconnect=true&useSSL=false";
