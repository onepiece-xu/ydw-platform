...
//	@Test
    public void generateCode() {
        //指定包名
        String packageName = "com.ydw.authentication";
        //指定生成的表名


        String[] tableNames = new String[]{"tb_clusters","tb_user_approve","tb_user_info"};
...
//        return "F:\\";
    ...
    private DataSourceConfig getDataSourceConfig() {
        String dbUrl = "jdbc:mysql://192.168.1.201:3306/cgp_paas?useUnicode=true&characterEncoding=utf8&autoReconnect=true&useSSL=false&serverTimezone=GMT%2B8";
