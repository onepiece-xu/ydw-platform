...
public class TbDevicesController extends BaseController{
     ...
     * 云网吧服务 网吧管理 获取设备信息
     */
    @GetMapping("/getNetBarDevices")
    @ResponseBody
    public ResultInfo getNetBarDevices(@RequestParam String clusterId,
                                       @RequestParam(required = false) String name){

        return  iTbDevicesService.getNetBarDevices(clusterId,name,buildPage());
