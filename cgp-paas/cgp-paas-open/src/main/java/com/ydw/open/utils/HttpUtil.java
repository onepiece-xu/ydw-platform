...
public class HttpUtil {
     ...
     * String
     */
    public static String doJsonPost(String url,Map<String,String> headers,Map<String,Object> params) {
        String result = null;
    ...
    public static String doJsonPost(String url, Map<String,String> headers, List<AppQueueVO> params) {
        String result = null;
        MediaType mediaType = MediaType.parse("application/json; charset=utf-8");
        RequestBody requestBody = RequestBody.create(mediaType, JSON.toJSONString(params));
    ...
    public static String doPost(String url, Map<String,String> headers, List<String> params) {
        String result = null;
        MediaType mediaType = MediaType.parse("application/json; charset=utf-8");
        RequestBody requestBody = RequestBody.create(mediaType, JSON.toJSONString(params));
        Builder builder = new Request.Builder().url(url).post(requestBody);
    ...
    public static byte[] doFilesPost(String url,Map<String,String> headers,Map<String,Object> params) {
        byte[] result = null;
        ...
        for(Map.Entry<String, Object> entry : params.entrySet()){
            if (entry.getValue() instanceof byte[]){
                byte[] file = (byte[]) entry.getValue();
                multipartBody.addFormDataPart(entry.getKey(), entry.getKey(),
                        RequestBody.create(MediaType.parse("application/octet-stream"),file));
//            if (entry.getValue() instanceof MultipartFile){
//                multipartBody.setType(MultipartBody.FORM).addFormDataPart(entry.getKey(),((MultipartFile) entry.getValue()).getOriginalFilename(),
//                        RequestBody.create(MediaType.parse("application/octet-stream"),
//                                new File("D:\\test\\6743065726167085344.jpg")));
            }else{
