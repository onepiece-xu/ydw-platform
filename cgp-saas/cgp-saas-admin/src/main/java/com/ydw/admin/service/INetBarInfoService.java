...
public interface INetBarInfoService extends IService<NetBarInfo> {
    ...
    ResultInfo getNetBarList(HttpServletRequest request, String name, String province, String city, String district,String identification, Page buildPage);
    ...
    ResultInfo getEnterpriseIdentification(HttpServletRequest request, Page buildPage);

    ResultInfo getNetbarbyClusterId(HttpServletRequest request, List<String> clusterIds);

    ResultInfo getNetbarApps(String id);
}
