...
public class SimpleMp {
    ...
    public void generateCode() {
        //指定包名
        String packageName = "com.ydw.netbar";
        //指定生成的表名
        String[] tableNames = new String[]{"tb_charging_record","tb_clusters",
        		"tb_custom_configure","tb_device_base","tb_user","tb_user_info","tb_enterprise"};
...
//        return path.substring(1, index) + projectName + "/src/main/java/";
    ...
    private DataSourceConfig getDataSourceConfig() {
        String dbUrl = "jdbc:mysql://192.168.1.201:3306/cgp_netbar?tinyInt1isBit=false&useUnicode=true&characterEncoding=utf8&autoReconnect=true&useSSL=false";
