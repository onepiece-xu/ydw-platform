...
public class SimpleMp {
    ...
    public void generateCode() {
        //指定包名
        String packageName = "com.ydw.game";
        //指定生成的表名
        String[] tableNames = new String[]{"tb_user","tb_enterprise",
        		"tb_clusters","tb_connect","tb_hangup","tb_app"};
...
//        return path.substring(1, index) + projectName + "/src/main/java/";
    ...
    private DataSourceConfig getDataSourceConfig() {
        String dbUrl = "jdbc:mysql://192.168.1.201:3306/cgp_game?tinyInt1isBit=false&useUnicode=true&characterEncoding=utf8&autoReconnect=true&useSSL=false";
