...
public class TagController  extends BaseController {
    @Autowired
    private ITagService iTbTagService;
    ...
    @ResponseBody
    public ResultInfo getAppListByTag(HttpServletRequest request, @RequestBody AppListByTagVO body) {

        return iTbTagService.getAppListByTag(request,body,buildPage(body));
    }

    @PostMapping(value = "/new/getAppListByTags")
    @ResponseBody
    public ResultInfo getAppListByTags(HttpServletRequest request, @RequestBody AppListByTagVO body) {

        return iTbTagService.getAppListByTags(request,body,buildPage(body));
    }
    ...
    @ResponseBody
    public ResultInfo add(HttpServletRequest request, @RequestBody Tag body) {
    ...
    @ResponseBody
    public ResultInfo updateTag(HttpServletRequest request, @RequestBody Tag body) {
     ...
     * 安卓获取标签
     */
    @GetMapping(value = "/androidTags")
    @ResponseBody
    public ResultInfo AndroidTagList(HttpServletRequest request) {

        return iTbTagService.AndroidTagList(request);
     ...
     * 猜你喜欢
     */
    @GetMapping(value = "/getRecommendAppByTag")
    @ResponseBody
    public ResultInfo getRecommendAppByTag(@RequestParam("id")String appId) {
        return iTbTagService.getRecommendAppByTag(appId);
    }
}
